...
```{r}
DaysSinceEphemera(as.POSIXct("2020-12-29 23:00:00", tz="UTC"))
```
...
PlanetList <- c("Mercury","Venus","Mars","Jupiter","Saturn")
DayList <- seq(
  from=as.POSIXct("2021-01-01", tz="UTC"),
  to=as.POSIXct("2021-12-31", tz="UTC"),
  by="days"
  )
